...
<section class="news-detail">
    <img src="<?=$arResult["DETAIL_PICTURE"]["SRC"]?>" alt="<?=$arResult["DETAIL_PICTURE"]["ALT"]?>" class="news-detail__bg" />
    <div class="container">
		...
		<?if($arParams["DISPLAY_NAME"]!="N" && $arResult["NAME"]):?>
			<h1 class="news-detail__title page-title">
				<?=$arResult["NAME"]?>
			</h1>
		<?endif;?>
    </div>
...
<section class="news-content header-breakpoint">
    <div class="container">
        <?
