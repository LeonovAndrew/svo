        ...
        if ($(input).hasClass("tel")) {
            ...
            if (input.matches("input:valid")) {
                ...
                if ($(input).attr("type") === "file") {
                    $(input).closest(".file").find("label").removeClass("input_error");
                }
            } else {
                input.classList.add("input_error");

                if ($(input).attr("type") === "file") {
                    $(input).closest(".file").find("label").addClass("input_error");
                }
            }
        }
...
$(() => {
    ...
    $(".header__mobile-btn").on("click", () => {
        $(".header__drop-down").slideToggle(300);
        $(".header__mobile-btn").toggleClass("active");
    });

    $(".header__drop-down-link").on("click", () => {
...
$(() => {
    ...
    if (+$("html").width() <= 768) {
        ...
        $(".support__more-btn").on("click", () => {
            openCount += 3;
            openElems(openCount);

            if (openCount >= $(".support-item").length) {
                $(".support__more-btn").css("display", "none");
            }
        });
...
$(() => {
    $(window).on("scroll", (e) => {
        ...
        const breakpointTop = $(".header-breakpoint").offset().top;

        if (+scroll >= +breakpointTop) {
            $(".header").css("position", "fixed");
            $(".header").slideDown(300);
            $(".header").addClass("blue");
            $(".header .btn").addClass("btn_white");
        }   else {
            ...
            $(".header .btn").removeClass("btn_white");
        }
    });
});
...
$(() => {
    ...
    $(".question__btn").on("click", (e) => {
        const current = $(e.currentTarget);

        $(current).next().slideToggle(300);
        $(current).parent().toggleClass("active");

        $(".question").not(current.parent()).removeClass("active");
        $(".question__hidden").not(current.next()).slideUp(300);
    });
});
